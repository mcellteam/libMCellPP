...
class my_dynamic_geometry_event(TCO_event):
  

class my_dynamic_geometry_listener(TCO_listener):
...
world.register_event_type(my_dynamic_geometry_event)

world.register_event_handler(my_dynamic_geometry_handler)

world.geometry.my_obj.

# Note world.add_counter is a convenience API to world.register_event_handler()
